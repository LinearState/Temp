...
alls = pd.read_csv("sentence/alls_sentence.csv", encoding='cp949')
navers = pd.read_csv("sentence/navers_sentence.csv", encoding='cp949')
kakaos = pd.read_csv("sentence/kakaos_sentence.csv", encoding='cp949')
sks = pd.read_csv("sentence/sks_sentence.csv", encoding='cp949')
kts = pd.read_csv("sentence/kts_sentence.csv", encoding='cp949')
lgs = pd.read_csv("sentence/lgs_sentence.csv", encoding='cp949')
